...
func appApplicationFixtureTests() []appApplicationFixtureTest {
	return []appApplicationFixtureTest{
		...
		{"v2 DELETE /v2/webclips/{webclipId}", "ios-webclip delete", []string{"ios-webclip", "delete", "fixture-id", "--yes", "--json"}, "DELETE", "/v2/webclips/fixture-id", nil, "", "v2-delete--v2-webclips-webclipid", 200, 409, false, true, nil},
		...
		{"v2 GET /v2/apps", "ios-app list", []string{"ios-app", "list", "--limit", "1", "--offset", "0", "--all", "--json"}, "GET", "/v2/apps", url.Values{"limit": {"1"}, "offset": {"0"}}, "", "v2-get--v2-apps", 200, 400, true, false, nil},
		...
		{"v2 GET /v2/itunesapps", "ios-itunesapp list", []string{"ios-itunesapp", "list", "--app-id", "fixture-id", "--limit", "1", "--offset", "0", "--all", "--json"}, "GET", "/v2/itunesapps", url.Values{"app_id": {"fixture-id"}, "limit": {"1"}, "offset": {"0"}}, "", "v2-get--v2-itunesapps", 200, 400, true, false, nil},
		...
		{"v2 GET /v2/provisioning-profiles/{id}/versions", "ios-provisioning-profile-version list", []string{"ios-provisioning-profile-version", "list", "--provisioning-profile", "fixture-id", "--limit", "1", "--offset", "0", "--all", "--json"}, "GET", "/v2/provisioning-profiles/fixture-id/versions", url.Values{"limit": {"1"}, "offset": {"0"}}, "", "v2-get--v2-provisioning-profiles-id-versions", 200, 400, true, false, nil},
		...
		{"v2 GET /v2/webclips", "ios-webclip list", []string{"ios-webclip", "list", "--limit", "1", "--offset", "0", "--all", "--json"}, "GET", "/v2/webclips", url.Values{"limit": {"1"}, "offset": {"0"}}, "", "v2-get--v2-webclips", 200, 400, true, false, nil},
		{"v2 GET /v2/webclips/{webclipId}", "ios-webclip get", []string{"ios-webclip", "get", "fixture-id", "--json"}, "GET", "/v2/webclips/fixture-id", nil, "", "v2-get--v2-webclips-webclipid", 200, 400, false, false, nil},
...
func TestAppApplicationOperationCoverage(t *testing.T) {
	...
	for _, operation := range generated.Operations() {
		if nouns[operation.Noun] && operation.AliasOf == "" {
...
func TestAppApplicationInputValidation(t *testing.T) {
	for _, arguments := range [][]string{{"preferred-region", "create"}, {"app-info", "patch", "fixture-id", "fixture-id", "fixture-id", "--body", "{}", "--icon-url", "https://example.test/icon.png"}, {"device-app", "list"}, {"ios-itunesapp", "list"}} {
